  ...
  <div class="header-top mobile-hide">
    <div class="container">
      <div class="wrapper flexitem">
        ...
        <div class="right">
          <ul class="flexitem main-links">
            <li><a href="admin_area/signUp.php">Sign Up</a></li>
            <li><a href="admin_area/logIn.php">My Account</a></li>
      ...
      <div class="wrapper flexitem">
        ...
        <div class="right">
          <ul class="flexitem second-links">
            ...
            <li>
              <a href="cart.php" class="iscart">
                <div class="icon-large">
                  <i class="ri-shopping-cart-line"></i>
                  <div class="fly-item">
                    <span class="item-nuber"><?php cart_item(); ?></span>
                  </div>
                </div>
                <div class="icon-text">
                  <div class="mini-text">Total</div>
                  <div class="cart-total">&#8377; <?php total_cart_price(); ?></div>
                </div>
              </a>
            </li>
          </ul>
      ...
      <div class="wrapper flexitem">
        ...
        <div class="right">
          <div class="search-box">
            <form action="page-category.php" method="GET" class="search">
              <span class="icon-large"
                ><i class="ri-search-line"></i
              ></span>
              <input type="search" name="search_box" placeholder="Search for products" />
              <button type="submit" name="search_button" value="search" name="">Search</button>
            </form>
          </div>
        </div>
      </div>
